  ...
  <ion-page>
    <ion-header :translucent="true">
      <ion-toolbar color="primed">
        ...
        <ion-title>Pending order</ion-title>
        <ion-buttons slot="end">
          <ion-button @click="ApproveConfirmation()">
            Approve
          </ion-button>
        </ion-buttons>
      </ion-toolbar>
    ...
    <ion-content :fullscreen="true">
      <ion-row style="background-color: #7464ff; color: white">
        <ion-col class="ion-margin-start ion-padding-bottom">
          ...
          <br v-if="order.submitted_time !== null" />
          ...
          <br v-if="order.custom_reference_id !== null" />
          <ion-text
          ...
          <ion-list>
            ...
            >
              <ion-label>
                ...
                <p>{{ firstLetterUpperCase(order.order_type) }}</p>
              </ion-label>
            </ion-item>
          </ion-list>
        </ion-card-content>
